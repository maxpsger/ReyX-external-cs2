...
namespace ConfigMenu {
	...
	void ResetToDefault() {
		...
		ESPConfig::FilledColor = ImColor(222, 77, 77, 1);
		ESPConfig::FilledColor2 = ImColor(222, 77, 77, 1);
		...
		ESPConfig::OutOfFOVArrowColor = ImColor(0, 0, 1, 1);
		...
		ESPConfig::BoxType = 0;
		ESPConfig::BoneColor = ImColor(255, 67, 89, 1);
		ESPConfig::BoxColor = ImColor(250, 115, 89, 1);
		ESPConfig::EyeRayColor = ImVec4(183, 64, 43, 1);
		...
		MiscCFG::HeadShootLineColor = ImColor(240, 65, 6, 1);
		...
		AimControl::AimFov = 16;
		AimControl::AimFovMin = 0.4f;
		AimControl::Smooth = 3.0f;

		ESPConfig::ShowLineToEnemy = false;
		LegitBotConfig::FovLineSize = 60.0f;
		TriggerBot::TriggerDelay = 2;
		TriggerBot::ShotDuration = 40;
		...
		AimControl::AimBullet = 0;

		LegitBotConfig::FovLineColor = ImVec4(198, 71, 21, 0.8);
		ESPConfig::LineToEnemyColor = ImVec4(200, 71, 26, 0.8);
