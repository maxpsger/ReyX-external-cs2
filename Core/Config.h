...
{
	inline std::string name = "ReyX";
	inline std::string version = "1.0.0.1";
	inline std::string author = "PCIe";
	...
	struct {
		...
		int MenuPage = 0;
		ImVec2 MainWinSize = ImVec2(700.f, 550.f);
		...
		ImVec2 Button5Pos = ImVec2(0.f, 295.f);
		ImVec2 ChildPos = ImVec2(60.f, 0.f);
		ImVec2 ChildSize = ImVec2(540.f, 400.f);
	...
	inline int HotKey = VK_INSERT; // Changed from END to INSERT for better compatibility
}
